...
My Arch setup as of December 2025 uses the following:

- Window manager: [MangoWC](https://mangowc.vercel.app/), [Hyprland](https://hypr.land/)
...
- Screenshots: [Satty](https://github.com/Satty-org/Satty)
